...
const Blog = () => {
    return (
        <div>
            ...
            <div className='bg-gray-200 p-3 rounded-lg mb-5'>
                <h4 className='text-2xl font-medium bg-indigo-200 p-2 mb-2 rounded-t-lg'>What is cors?</h4>
                <p>
            ...
            <div className='bg-gray-200 p-3 rounded-lg mb-5'>
                <h4 className='text-2xl font-medium bg-indigo-200 p-2 mb-2 rounded-t-lg'>Why are you using firebase? What other options do you have to implement authentication?</h4>
                <p>
            ...
            <div className='bg-gray-200 p-3 rounded-lg mb-5'>
                <h4 className='text-2xl font-medium bg-indigo-200 p-2 mb-2 rounded-t-lg'>How does the private route work?</h4>
                <p>
                    The private route component is similar to the public route, the only change is that redirect URL and authenticate condition. If the user is not authenticated he will be redirected to the login page and the user can only access the authenticated routes If he is authenticated (Logged in).
                </p>
            </div>
            <div className='bg-gray-200 p-3 rounded-lg mb-10'>
                <h4 className='text-2xl font-medium bg-indigo-200 p-2 mb-2 rounded-t-lg'>What is Node? How does Node work?</h4>
                <p>
