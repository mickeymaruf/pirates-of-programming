...
const Checkout = () => {
    ...
    return (
        <div>
            ...
            <div className='border p-2 bg-gray-200 text-gray-800 flex items-center gap-5 rounded-lg lg:w-2/3 mx-auto'>
                <img className='w-40 md:w-48 rounded-lg' src={thumbnail} alt="" />
